...
# --- TEST 4: POST Crear ---
@patch('cliente_bp.create_cliente')
...
@patch('cliente_bp.update_cliente')
...
@patch('cliente_bp.delete_cliente')
...
# --- TEST 8: GET CDMX ---
@patch('cliente_bp.get_clientes_cdmexico')
